...
{
'serviceImage':image.asset->url + "?auto=format&w=300",
code,
  name,
  description,
  image_url,
  ...
  { 'serviceImage':image.asset->url + "?auto=format&w=300",code,description, image_url, name,
    "title": coalesce(
    title[_key == 'pt'][0].value,
    title[_key == 'pt'][0].value,
    "Missing translation"
    ...
    { 'serviceImage':image.asset->url + "?auto=format&w=300",code,name,
      "title": coalesce(
    title[_key == 'pt'][0].value,
    title[_key == 'pt'][0].value,
    "Missing translation"
...
code,
  ...
  { 'serviceImage':image.asset->url + "?auto=format&w=300", code,description, image_url, name,
    ...
    "relatedCustomerNeedsDetails": *[_type=='execlogCustomerNeedDetail' && references(^._id)] | order(title asc)
    { 'serviceImage':image.asset->url + "?auto=format&w=300",code,name,description,
      "title": coalesce(
    title[_key == $locale][0].value,
    title[_key == 'pt'][0].value,
    "Missing translation"
...
export const TAXONOMIES_QUERY_LOCALIZED = groq`*[_type == "taxonomy"]
 ...
 {   
    ...
    "imageUrl": image.asset->url + "?auto=format&w=250",
    taxons[]->{
        "title": coalesce(
        title[_key == $locale][0].value,
        title[_key == 'pt'][0].value,
        ...
        taxons[]->{
            ...
            products[]->{"imageUrl": image.asset->url + "?auto=format&w=250",
            "title": coalesce(
                title[_key == $locale][0].value,
                title[_key == 'pt'][0].value,
                "Missing translation"
                ...
                sku,
                "images": images[]{
                          'url': asset->url + "?auto=format&w=250",
                          },
                    "title": coalesce(
                    title[_key == $locale][0].value,
                    title[_key == 'pt'][0].value,
 ...
 {   
    ...
    taxons[]->{
        ...
        taxons[]->{
            ...
            products[]->{"imageUrl": image.asset->url + "?auto=format&w=300",
            "title": coalesce(
                title[_key == $locale][0].value,
                title[_key == 'pt'][0].value,
                "Missing translation"
            ...
            "Missing translation"
                ...
                sku,
                "images": images[]{
                          'url': asset->url + "?auto=format&w=300",
                          },
                    "title": coalesce(
                    title[_key == $locale][0].value,
                    title[_key == 'pt'][0].value,
  ...
  && title[_key == $locale][0].value == $taxons][0]
{
    ...
    "taxonomies": *[_type == "taxonomy"
        ...
        "product": *[_type == "product" && title[_key == $locale].value match $slug][0]
            { "imageUrl": image.asset->url + "?auto=format&w=300",
                "title": coalesce(
                title[_key == $locale][0].value,
            ...
            "Missing translation"
                ...
                variants[]->{ sku,
                    "images": images[]{
                        'url': asset->url + "?auto=format&w=500",
                    },
                    "title": coalesce(
                    title[_key == $locale][0].value,
                    "Missing translation " + $locale + "/" + title[_key == 'pt'][0].value,
...
"taxonomies": *[_type == "taxonomy"
    ...
    taxons[]->{
      ...
      products[]->{"imageUrl": image.asset->url + "?auto=format&w=500",
            "title": coalesce(
            title[_key == $locale][0].value,
            title[_key == 'pt'][0].value,
            "Missing translation"
